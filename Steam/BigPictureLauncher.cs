...
public static class BigPictureLauncher
{
    ...
    public static IntPtr FindRunningGameWindow()
    {
        ...
        EnumWindows((hwnd, _) =>
        {
            ...
            // ever mistaking Claude, Discord, a browser, or any other window for the game (which once got
    ...
    /// non-game (Claude, Discord, a browser) can never be suspended by mistake.</summary>
