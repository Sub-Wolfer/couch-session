...
internal static class Words
{
    ...
    public const string HotkeyHdrNote =
            ...
            "The HDR hotkeys act on your **main display only** — the TV during a session, "
            + "or your monitor at the desk. Every other display is left alone.";
    ...
    public const string ShortcutHdrWhy =
            ...
            + "settings. **Turn it on just before you launch a game (or while one is running) "
            + "and that game is remembered**: added to the HDR Switching list so HDR comes on "
            + "for it by itself next time, and off again when it closes. That last part is a "
            + "setting of its own on the HDR Switching page, on by default.\n\nBefore launching "
            + "is the better order — most games read the display at startup.";
    ...
    public const string ShortcutSessionWhy =
            ...
            "Starts or ends a session anywhere in Windows, even over a game. Set a keyboard "
            + "combo, a controller one, or both — click a box and press the keys, or hold "
            + "**two or more** buttons together so it cannot fire mid-game.";
